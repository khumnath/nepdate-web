			...
			<div className="flex items-center h-full w-full relative px-1">
                ...
                "
                  ...
                  "
								...
								<button onClick={() => { handleReloadApp(), setShowMore(false); }} className="w-full flex items-center gap-3 px-3 py-2
                    text-left text-[13px]
                    rounded-md
                    hover:bg-slate-100 dark:hover:bg-gray-600
                    focus:bg-slate-100 dark:focus:bg-gray-600
                    text-gray-800 dark:text-gray-200"><RefreshCcw className="w-4 h-4" />Reload</button>
							</div>
						)}
					</div>
				)}
