        ...
        <div className="flex flex-col items-center justify-between p-2 bg-slate-100 dark:bg-gray-700/50 flex-shrink-0 w-full">
            ...
            >
                ...
                <button
                    ...
                    className="sm:flex-none h-9 sm:h-10 w-9 sm:w-8 rounded-lg bg-[rgb(37_99_235)] dark:bg-gray-700 shadow-sm hover:shadow-md
                     transition-all duration-200 text-white dark:text-gray-300 hover:bg-blue-700
