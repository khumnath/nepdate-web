import{j as e,R as Z,r as x,w as re,x as I,D as se}from"./vendor-react-CxARfaPr.js";import{v as le}from"./vendor-other-By8KEE3n.js";import{u as ie,m as de,g as _,e as oe,s as Y,t as q,c as J,v as Q,G as V,l as ne,w as K}from"./core-astro-lCqygZnm.js";import{a as ce,u as ee,A as W}from"./index-BeqxmJFB.js";import{A as fe,G as ae}from"./google-play-badge-DgGAyOYp.js";import{M as me}from"./MonthlyEvents-CnF37o7P.js";import{P as ge}from"./PrintAdDialog-Bu4EqOuG.js";import"./vendor-leaflet-Bjm2FGmM.js";import"./core-data-BzebUjTq.js";import"./LoadingSpinner-Clq7L-lN.js";const xe=["आइत","सोम","मङ्गल","बुध","बिही","शुक्र","शनि"],he=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],te=({system:m,year:c,monthIndex:s,theme:a,highlightToday:u=!1})=>{const{location:l,isStashLoaded:F,ayanamsaMethod:i,engineType:S,isTopocentric:o,useElevation:j}=ce(),{language:R}=ee(),P=m==="bs"?xe:he,H=(()=>{const t=[];if(m==="bs"){const n=ie(c,s);if(!n)return t;const y=n.startDayOfWeek||0,h=y+n.totalDays>35?42:35;for(let b=0;b<h;b++)if(b<y||b>=y+n.totalDays)t.push({day:0,adDay:0,isCurrent:!1,date:new Date(0),weekday:b%7});else{const p=b-y+1,g=de(c,s,p),f=_(g);let w="",v=!1,T=!1,G=!1,A=!1;try{const L=j?l.elevation:0,E=oe(g,l.latitude,l.longitude,l.offset,R,l.zoneId,F,L,i,S,o);E&&!E.error&&(w=E.tithi?.name||"",v=w==="पूर्णिमा",T=w==="अमावस्या",G=(E.events?.length??0)>0,A=E.events?.some(r=>r.holiday)??!1)}catch{}const C=new Date,D=u&&g.getUTCFullYear()===C.getFullYear()&&g.getUTCMonth()===C.getMonth()&&g.getUTCDate()===C.getDate();t.push({day:p,adDay:g.getUTCDate(),isCurrent:!0,isToday:D,date:g,weekday:f,tithi:w,isPurnima:v,isAmavasya:T,hasEvent:G,isHoliday:A})}}else{const n=Y(c,s,1),y=Y(c,s+1,0),h=_(n),b=h+y.getUTCDate()>35?42:35;for(let p=0;p<b;p++)if(p<h||p>=h+y.getUTCDate())t.push({day:0,adDay:0,isCurrent:!1,isToday:!1,date:new Date(0),weekday:p%7});else{const g=p-h+1,f=Y(c,s,g),w=_(f),v=q(f),T=new Date,G=u&&f.getUTCFullYear()===T.getFullYear()&&f.getUTCMonth()===T.getMonth()&&f.getUTCDate()===T.getDate();t.push({day:g,adDay:v.day,isCurrent:!0,isToday:G,date:f,weekday:w})}}return t})(),B=t=>m==="bs"?J(t):String(t);return e.jsxs("div",{className:"cal-grid-container",style:{"--cal-primary":a.primary,"--cal-secondary":a.secondary,"--cal-bg":a.bg,"--cal-grid-bg":a.gridBg,"--cal-weekday-gradient":a.weekdayGradient,"--cal-saturday-weekday-bg":a.saturdayWeekdayBg||a.weekdayGradient,"--cal-day-bg":a.dayBg,"--cal-day-border":a.dayBorder,"--cal-day-text":a.dayText,"--cal-saturday-text":a.saturdayText,"--cal-saturday-bg":a.saturdayBg||a.dayBg,"--cal-saturday-border":a.saturdayBorder||a.dayBorder,"--cal-tithi-text":a.tithiText,"--cal-today-bg":a.todayBg||`color-mix(in srgb, ${a.primary} 15%, ${a.dayBg})`,"--cal-today-border":a.todayBorder||a.primary},children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
        .cal-grid-container {
